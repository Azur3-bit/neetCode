...
string covert_to_binary(int curr){
...
auto answer(vector<int> nums){
    ...
    string test = covert_to_binary(curr);

    dbg(test);

    // string test = "1001";

    long long result = binary_to_decimal(test);
    dbg(result);
