...
vector<vector<int>> helper_subarray(const vector<int> &nums){
...
int sol(vector<vector<int>> nums){
...
auto answer(vector<int> nums){
    ...
    ans = helper_subarray(nums);
    int solution = sol(ans);
