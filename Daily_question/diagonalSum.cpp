...
auto answer(vector<int> nums){
    ...
    // vector<vector<int>> mat = {{7,1,4,5,6},{2,5,1,6,4},{1,5,4,3,2},{1,2,7,3,4}};

    // vector<vector<int>> mat = {{7,1,4,5},{2,5,1,6},{1,5,4,3},{1,2,7,3}};


    vector<vector<int>> mat = {{10,1,3},{1,1,1},{3,1,1}};
